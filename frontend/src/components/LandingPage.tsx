    ...
    <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-black/40 backdrop-blur-3xl">
      ...
      <nav className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-4">
          {process.env.NODE_ENV === "development" && onToggleMockData && (
            <button
              onClick={onToggleMockData}
              className={`inline-flex items-center space-x-2 rounded-full border px-4 py-2 text-sm backdrop-blur-md transition-all duration-300 ${
                useMockData
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center w-full max-w-6xl px-6 gap-4 md:gap-8">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left md:w-1/2">
          ...
          <p className="text-lg md:text-xl text-white/50 font-light mb-8 max-w-xl leading-relaxed">
            Abstract intent translated into physical space. Experience a new
            dimension of contextual spatial intelligence.
          </p>
